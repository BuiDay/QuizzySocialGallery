...
const Page = () => {
    ...
    useEffect(() => {
        const body = {
            currentPage,
            forderName: "social-media-strategy",
            productId: "668d0817cbc728450ab5d533"
        }
    ...
    useEffect(() => {
        function handleKeyDown(e: any) {
            ...
            if (e.keyCode === 39 && currentPage < 30) {
                setCurrentPage((item: any) => (Number(item) + 1));
            }
        }
    ...
    return (
        <UseCheckBoughtProduct productId="668d0817cbc728450ab5d533">
            <div className="h-screen relative"  >
                ...
                <div className="absolute w-full bottom-[50px] left-0">
                    <div className="w-[95%] flex justify-between items-center m-auto">
                        ...
                        <Button
                            disabled={Number(currentPage) >= 30 || isLoading}
                            onClick={() => setCurrentPage((item: any) => (Number(item) + 1))}
