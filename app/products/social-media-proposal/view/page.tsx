...
const Page = () => {
    ...
    useEffect(() => {
        const body = {
            currentPage,
            forderName: "social-media-proposal",
            productId:"668d076acbc728450ab5d527"
        }
    ...
    return (
        <UseCheckBoughtProduct productId="668d076acbc728450ab5d527">
        <div className="h-screen relative"  >
            ...
            <div className="absolute w-full bottom-[50px] left-0">
                <div className="w-[95%] flex justify-between items-center m-auto">
                    ...
                    <Button
                        disabled={Number(currentPage) >= 9 || isLoading}
                        onClick={() => setCurrentPage((item: any) => (Number(item) + 1))}
